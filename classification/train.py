...
parser.add_argument('--cnn_path', default='/home/ains/An/histologic/TJ_CH/lung_proj/classification/cnn.json', metavar='CNN_PATH', type=str,
                    help='Path to the config file in json format')
parser.add_argument('--save_path', default='/home/ains/An/histologic/TJ_CH/lung/256_patch_binary/result/', metavar='SAVE_PATH', type=str,
...
def run(args):
    ...
    if args.pre_train:
        ckpt = torch.load(args.pre_trainpath)
