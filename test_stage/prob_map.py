...
from test.vsi_producer import VSIPatchDataset  # noqa


## generate prob map with vsi slides
parser = argparse.ArgumentParser(description='Get the probability map of tumor patch predictions given a VSI')
parser.add_argument('--vsi_path', default='/media/ains/DataA/An/lung/AC/or/500-95-534302-3.vsi', metavar='VSI_PATH', type=str,
                    help='Path to the input VSI file')   #######change
...
parser.add_argument('--num_workers', default=0, type=int, help='number of workers to use to make batch, default 5')
...
def make_dataloader(args, cnn, flip='NONE', rotate='NONE'):
    ...
    dataloader = DataLoader(
        VSIPatchDataset(args.vsi_path, args.mask_path,
